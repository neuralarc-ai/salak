...
-- Note: You'll need to hash this password using bcrypt. Use the register API or manually insert with hashed password
-- For testing, you can use: https://bcrypt-generator.com/ (rounds: 10)
-- Example hash for "admin123": $2a$10$rOzJqZqZqZqZqZqZqZqZqOqZqZqZqZqZqZqZqZqZqZqZqZqZqZqZq

-- You can create the admin user via the register API endpoint or manually:
