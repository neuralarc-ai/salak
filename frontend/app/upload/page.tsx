...
export default function UploadPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      // For now, we'll create document records
      // In production, you'd upload files to storage first, then create records
      const uploadPromises = files.map(async (file) => {
        ...
        const response = await api.post('/documents', {
          ...
          file_path: `/uploads/${file.name}`, // In production, use actual uploaded path
          file_size: file.size,
          file_type: file.type,
