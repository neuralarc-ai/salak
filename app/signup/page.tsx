  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (data.success) {
        ...
        // Profile creation happens asynchronously via Supabase trigger
        ...
        console.log('Registration response missing success data:', data)
    ...
    <div className="flex min-h-screen items-center justify-center bg-muted/50 p-4">
      <Card className="w-full max-w-md">
        <CardHeader className="space-y-1">
          ...
          <CardDescription>
            Sign up to access SALAK - Smart Resource & Document Management System
          </CardDescription>
        </CardHeader>
