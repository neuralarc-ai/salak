...
export default function DashboardPage() {
  ...
  useEffect(() => {
    // AuthGuard has already validated authentication, safe to fetch data immediately
    fetchDashboardData()
  }, [])
  ...
  const fetchDashboardData = async () => {
    try {
      setLoading(true)
      console.log('Dashboard: Starting data fetch (authentication already validated by AuthGuard)')

      // AuthGuard has validated JWT token, safe to make API calls
      ...
      console.log('Dashboard: API responses received', {
        documentsSuccess: documentsRes.success,
      ...
      // AuthGuard will handle authentication errors and redirects
    } finally {
      setLoading(false)
    }
  }
