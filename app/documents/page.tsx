...
import { Search, FileText, Eye, MoreVertical, Loader2, Share2, Trash2 } from "lucide-react"
import {
  DropdownMenu,
  DropdownMenuContent,
  DropdownMenuItem,
...
export default function DocumentsPage() {
  ...
  const handleShare = async (id: string, documentName: string) => {
    try {
      ...
      if (response.success && response.shareUrl) {
        ...
        alert(`Link copied to clipboard! Share link expires in ${response.expiresIn}.`)
      } else {
